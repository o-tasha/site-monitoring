...
сообщений. Для запроса ресурса компонент resourceMonitor использует HTTP-клиент, реализованный на базе библиотеки cURL. Для хранения истории ответов с некорректными
ответами используется СУБД MySQL, поэтому для создания таблицы необходимо выполнить миграцию.
